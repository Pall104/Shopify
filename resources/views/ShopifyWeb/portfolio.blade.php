    ...
    <div style="display: flex; flex-direction: row; justify-content: space-around;color:white;margin-left: 150px;" id="footer-above">
        ...
        <div >
            ...
            <ul style="display: flex;flex-direction: row; justify-content: space-evenly;">
                ...
                <li>
                    <a class="button social" href="https://github.com/hallaathrad"></a>
                </li>
                <li>
                    <a class="button social" href="https://twitter.com/hallaathrad"></a>
                </li>
                <li>
                    <a class="button social" href="https://www.flickr.com/photos/hallaathrad/"></a>
                </li>
            </ul>
        </div>
    </div>
